	...
	<div class="contents md:flex md:flex-col">
		<div class="order-2 mb-10 md:mb-0">
			...
			<div class="border-2 border-solid border-black bg-yellow-100 p-3 space-y-3">
				...
				<Paragraph variant="xs" class="font-bold italic">We’re grateful for the assistance of our readers, alongside RØDE and Heaps Normal for helping us to get back online.</Paragraph>
				...
				<div class="space-y-2">
					<div class="flex flex-row gap-x-2"><Button label="Donate Now" variant="primary" pointer="" href="https://checkout.square.site/merchant/ML6CT8VAK4J47/checkout/SQ5WSOGMBCBYECOZF2JANBSX" /> <Button label="Wall of Legends" variant="outline" class="bg-white" pointer="" href="/wall-of-legends" /></div>
					<div class="text-xs"><a href="/about/commercial" class="black underline">Commercial sponsorship and data API licensing</a></div>
				</div>
