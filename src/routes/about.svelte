	...
	<div class="grid md:grid-cols-sidebar-right-wide">
		...
		<div class="about-copy space-y-6 sm:pr-20">
			...
			<div>
				...
				<p>The site was built with substantial help from the following wonderful humans without whom it would not have been possible!</p>
			...
			<div>
				...
				<p>You're welcome to read this code, get inspiration from it, fork it, deploy it or drop a pull request in with some suggestions. We just ask that anything you do be done in the spirit of the community project.
				</p>
			</div>
