<script>
	...
	const variantClasses = {
		'2xl': 'font-serif font-light text-4xl md:text-5xl lg:text-7xl mb-5',
		xl: 'font-serif font-light text-4xl lg:text-5xl mb-5',
		lg: 'font-serif font-light text-2xl lg:text-4xl mb-5',
		md: 'font-serif font-light text-xl lg:text-2xl mb-5',
		sm: 'font-sans font-bold text-lg lg:text-xl mb-5',
